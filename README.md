A Sprint Boot project that creates a single service where you upload a resume. The service parses work and education content from the resume and sends it back to the client as a JSON.
